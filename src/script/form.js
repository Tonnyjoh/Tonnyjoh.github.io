...
/**
 * Affiche une notification toast (succès ou erreur) en haut à droite pendant 5s,
 * avec les transitions d'entrée/sortie et l'icône correspondant au type.
 * @param {string} message - Texte affiché dans le toast.
 * @param {'success'|'error'} type - Détermine couleur et icône.
 */
...
// Soumission du formulaire de contact vers Web3Forms (service tiers, pas de backend propre).
